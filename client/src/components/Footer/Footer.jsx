...
export default function Example() {
  return (
    ...
    >
      <div className="h-60 mb-4 mx-[4rem] text-center ">
        <h1 className="text-3xl font-semibold pt-14">Join Our Community</h1>
        <div className="flex justify-center space-x-12 mt-9">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-white  hover:text-white hover:opacity-80 p-2 bg-[#238EF9] rounded-lg"
            >
      ...
      <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 lg:py-8 lg:pt-5 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <img
              ...
              alt="EtherX"
            />
            <h1 className="text-3xl font-bold ml-3 ">EtherX</h1>
            </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-white xl:text-center">
            &copy; 2023 EtherX, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
